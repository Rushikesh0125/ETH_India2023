...
var getContractArgs = function (contractName, networkName) { return __awaiter(void 0, void 0, void 0, function () {
    var constants, args;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, (0, getConstants_1.CONSTANTS)(networkName)];
            case 1:
                constants = _a.sent();
                args = [];
                if (contractName == "CrossChainToken" ||
                    ...
                    args[0] = constants === null || constants === void 0 ? void 0 : constants.router;
                }
                    ...
                    args[0] = constants === null || constants === void 0 ? void 0 : constants.connectorAddress;
                    args[1] = constants === null || constants === void 0 ? void 0 : constants.zetaConsumerAddress;
                    args[2] = constants === null || constants === void 0 ? void 0 : constants.zetaTokenAddress;
                }
